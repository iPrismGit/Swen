...
import com.iprism.swen.databinding.ActivityPharmacySearchBinding
...
class PharmacySearchActivity : AppCompatActivity() {
    ...
    private var pharmacies = mutableListOf<com.iprism.swen.models.pharmacies.MainDataItem>()
    ...
    private fun setUpHospitals() {
        pharmaciesAdapter = PharmaciesAdapter(pharmacies as ArrayList<com.iprism.swen.models.pharmacies.MainDataItem?>)
