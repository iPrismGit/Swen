...
import com.iprism.swen.databinding.ActivitySymptomHospitalsBinding
...
import com.iprism.swen.repository.SymptomsRepository
import com.iprism.swen.utils.UiState
import com.iprism.swen.utils.User
import com.iprism.swen.utils.getUserDetails
import com.iprism.swen.viewmodels.SymptomHospitalsViewModel
import com.iprism.swen.viewmodels.ViewModelFactory

class SymptomHospitalsActivity : AppCompatActivity() {

    private lateinit var binding : ActivitySymptomHospitalsBinding
    private lateinit var viewModel: SymptomHospitalsViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySymptomHospitalsBinding.inflate(layoutInflater)
        setContentView(binding.root)
        if (intent.hasExtra("symptomId1")) {
            symptomId = intent.getStringExtra("symptomId1")!!
    ...
    private fun setUpHospitals() {
        ...
        hospitalsAdapter.setOnDoctorItemClickListener(object : OnHospitalItemClickListener{
            override fun onItemClicked(hospitalId: String) {
                val intent = Intent(this@SymptomHospitalsActivity,
                    SurgeonSymptomDoctorsActivity::class.java)
                intent.putExtra("hospitalId", hospitalId)
                intent.putExtra("symptomId1", symptomId)
    ...
    private fun initViewModel() {
        ...
        val factory = ViewModelFactory { SymptomHospitalsViewModel(repository) }
        viewModel = ViewModelProvider(this, factory)[SymptomHospitalsViewModel::class.java]
    }
