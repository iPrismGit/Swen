...
import com.iprism.swen.adapters.MedicineBookedAdapter
import com.iprism.swen.databinding.ActivityHospitalMedicineBookingDetailsBinding
import com.iprism.swen.models.hospitalmedbookingdetails.BookingDetails
...
import com.iprism.swen.viewmodels.PharmacyBookingsViewModel
...
class PharmacyBookingDetailsActivity : AppCompatActivity() {
    ...
    private fun fetchBookingDetails() {
        ...
        NetworkRetryHelper.checkAndCallWithRetry(this, request) { req ->
            viewModel.fetchPharmacyBookingDetails(req)
        }
