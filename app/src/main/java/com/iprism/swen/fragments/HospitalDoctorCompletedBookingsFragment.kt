...
import com.iprism.swen.activities.HospitalDoctorBookingDetailsActivity
...
import com.iprism.swen.viewmodels.HospitalDoctorBookingsViewModel
import com.iprism.swen.viewmodels.ViewModelFactory

class HospitalDoctorCompletedBookingsFragment : Fragment() {
    ...
    private fun fetchBookings() {
        ...
        NetworkRetryHelper.checkAndCallWithRetry(requireContext(), request) { req ->
            viewModel.getHospitalDoctorCompletedBookings(request)
        }
