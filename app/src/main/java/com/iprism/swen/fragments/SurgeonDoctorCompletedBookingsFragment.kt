...
import com.iprism.swen.databinding.FragmentAppointmentDoctorCompletedBookingsBinding
...
class SurgeonDoctorCompletedBookingsFragment : Fragment() {

    private lateinit var binding: FragmentAppointmentDoctorCompletedBookingsBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentAppointmentDoctorCompletedBookingsBinding.inflate(inflater, container, false)
        setUpBookings()
        initViewModel()
        observeResponse()
        fetchBookings()
    ...
    private fun fetchBookings() {
        ...
        NetworkRetryHelper.checkAndCallWithRetry(requireContext(), request) { req ->
            viewModel.fetchSurgeonDoctorsCompletedBookings(req)
        }
