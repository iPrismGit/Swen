...
import com.iprism.swen.adapters.OnlineDoctorBookingsAdapter
import com.iprism.swen.databinding.FragmentPharmacyOnGoingBinding
import com.iprism.swen.interfaces.OnOnlineDoctorBookingItemClickListener
import com.iprism.swen.models.onlinedoctorbookinghistory.HistoryItem
...
import com.iprism.swen.viewmodels.OnlineDoctorBookingsViewModel
import com.iprism.swen.viewmodels.ViewModelFactory

class OnlineDoctorOnGoingBookingsFragment : Fragment() {

    private lateinit var binding : FragmentPharmacyOnGoingBinding
    private lateinit var viewModel: OnlineDoctorBookingsViewModel
    ...
    private fun setUpBookings() {
        ...
        onlineDoctorBookingsAdapter.setOnDoctorItemClickListener(object :
            ...
            override fun onItemClicked(bookingId : String) {
                val intent = Intent(requireContext(), OnlineDoctorBookingDetailsActivity::class.java)
    ...
    private fun initViewModel() {
        ...
        val factory = ViewModelFactory { OnlineDoctorBookingsViewModel(repository) }
        viewModel = ViewModelProvider(this, factory)[OnlineDoctorBookingsViewModel::class.java]
    }
    ...
    private fun fetchBookings() {
        ...
        NetworkRetryHelper.checkAndCallWithRetry(requireContext(), request) { req ->
            viewModel.getOnlineDoctorBookings(req)
        }
