...
import com.iprism.swen.activities.PharmacyBookingDetailsActivity
...
class PharmacyCompletedBookingsFragment : Fragment() {
    ...
    private fun fetchBookings() {
        ...
        NetworkRetryHelper.checkAndCallWithRetry(requireContext(), request) { req ->
            viewModel.fetchPharmacyCompletedBookings(req)
        }
