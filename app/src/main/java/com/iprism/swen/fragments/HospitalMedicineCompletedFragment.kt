...
import com.iprism.swen.activities.HospitalMedicineBookingDetailsActivity
import com.iprism.swen.adapters.HospitalMedicineBookingsAdapter
...
import com.iprism.swen.viewmodels.HospitalMedBookingsViewModel
import com.iprism.swen.viewmodels.ViewModelFactory

class HospitalMedicineCompletedFragment : Fragment() {
    ...
    private fun setUpBookings() {
        hospitalMedicineBookingsAdapter = HospitalMedicineBookingsAdapter(bookings as ArrayList<BookingsItem?>)
        ...
        hospitalMedicineBookingsAdapter.setOnBookingItemClickListener(object :
            ...
            override fun onItemClicked(id: String, bookingType : String) {
                val intent = Intent(requireContext(), HospitalMedicineBookingDetailsActivity::class.java)
    ...
    private fun fetchBookings() {
        ...
        val request = HospitalMedicineOngoingBookingRequest(userDetails[User.ID]!!.toInt(), userDetails[User.LANG].toString(), currentPage, userDetails[User.AUTH_TOKEN].toString())
        NetworkRetryHelper.checkAndCallWithRetry(requireContext(), request) { req ->
            viewModel.fetchHospitalMedCompletedBookings(req)
        }
