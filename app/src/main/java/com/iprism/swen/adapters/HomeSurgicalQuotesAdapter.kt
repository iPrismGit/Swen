...
class HomeSurgicalQuotesAdapter(var context: Context, var surgicalQuotes: List<SurgicalQuote>) :
    RecyclerView.Adapter<HomeSurgicalQuotesAdapter.HomeSurgicalQuoteViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): HomeSurgicalQuotesAdapter.HomeSurgicalQuoteViewHolder {
        val binding =
    ...
    override fun onBindViewHolder(
        holder: HomeSurgicalQuotesAdapter.HomeSurgicalQuoteViewHolder,
        position: Int
    ) {
