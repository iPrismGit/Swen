...
class DietTipsAdapter(var context: Context, var videos : List<MainDataItem>) : RecyclerView.Adapter<DietTipsAdapter.TestimonialViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): DietTipsAdapter.TestimonialViewHolder {
    ...
    override fun onBindViewHolder(
        holder: DietTipsAdapter.TestimonialViewHolder,
        position: Int
    ) {
