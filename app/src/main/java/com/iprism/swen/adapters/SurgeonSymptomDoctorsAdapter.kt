...
import com.iprism.swen.databinding.DoctorItem1Binding
...
import com.iprism.swen.viewholders.DoctorItem1ViewHolder
import com.iprism.swen.viewholders.DoctorItemViewHolder
import com.iprism.swen.viewholders.ItemLoadingViewHolder

class SurgeonSymptomDoctorsAdapter(private val doctors : ArrayList<DoctorsItem?>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private var onDoctorItemClickListener: OnSurgeonSymptomDoctorItemClickListener? = null

    fun setOnDoctorItemClickListener(onDoctorItemClickListener: OnSurgeonSymptomDoctorItemClickListener?) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding = DoctorItem1Binding.inflate(LayoutInflater.from(parent.context), parent, false)
        val itemLoadingBinding = ItemLoadingBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return if (viewType == VIEW_TYPE_ITEM) {
            DoctorItem1ViewHolder(binding)
        } else {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is DoctorItem1ViewHolder) {
            ...
            if (doctor.languages.isNullOrEmpty()) {
                holder.binding.languagesTxt.visibility = View.VISIBLE
                holder.binding.languagesTxt.text = doctor.languages
            } else {
                holder.binding.languagesTxt.visibility = View.GONE
            }
            ...
            holder.binding.bookAppointmentBtn.setOnClickListener(View.OnClickListener {
