...
import com.iprism.medrayder.databinding.ActivityLocationBinding;
...
public class LocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(com.iprism.medrayder.R.id.map);
