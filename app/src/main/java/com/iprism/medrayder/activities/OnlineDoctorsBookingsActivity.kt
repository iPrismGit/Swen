...
import OnlineDoctorBookingsViewPagerAdapter
...
import com.iprism.medrayder.databinding.ActivityOnlineDoctorsBookingsBinding

class OnlineDoctorsBookingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = OnlineDoctorBookingsViewPagerAdapter(this)
