...
import com.iprism.medrayder.activities.HospitalDiagnosticTestBookingDetailsActivity
...
class HospitalDiagnosticTestsCompletedBookingsFragment : Fragment() {
    ...
    private fun setUpBookings() {
        ...
        labTestBookingsAdapter.setOnBookingItemClickListener(object :
            ...
            override fun onItemClicked(id: String, bookingType: String) {
                val intent = Intent(
                    requireContext(),
                    HospitalDiagnosticTestBookingDetailsActivity::class.java
                )
    ...
    private fun initViewModel() {
        ...
        viewModel =
            ViewModelProvider(this, factory)[HospitalDiagnosticTestsBookingsViewModel::class.java]
    }
    ...
    private fun fetchBookings() {
        ...
        NetworkRetryHelper.checkAndCallWithRetry(requireContext(), request) { req ->
            viewModel.fetchHospitalDiagnosticTestsCompletedBookings(req)
        }
