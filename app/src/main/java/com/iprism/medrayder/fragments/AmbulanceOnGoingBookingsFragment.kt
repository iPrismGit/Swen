...
import com.iprism.medrayder.activities.HospitalAmbulanceBookingDetailsActivity
import com.iprism.medrayder.activities.TrackingActivity
import com.iprism.medrayder.adapters.HospitalAmbulanceBookingsAdapter
import com.iprism.medrayder.databinding.FragmentHospitalMedicineObGoingBinding
import com.iprism.medrayder.interfaces.OnAmbulanceBookingItemClickListener
...
import com.iprism.medrayder.viewmodels.HospitalAmbulanceBookingsViewModel
...
class AmbulanceOnGoingBookingsFragment : Fragment() {
    ...
    private fun setUpBookings() {
        ...
        hospitalAmbulanceBookingsAdapter.setOnBookingItemClickListener(object :
            ...
            override fun onCallClicked(mobile: String) {
                this@AmbulanceOnGoingBookingsFragment.mobile = mobile
    ...
    private fun fetchBookings() {
        ...
        NetworkRetryHelper.checkAndCallWithRetry(requireContext(), request) { req ->
            viewModel.fetchHospitalAmbulanceOngoingBookings(req)
        }
